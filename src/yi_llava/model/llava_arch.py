...
import torch
from yi_llava.model.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, key_info
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            if (cur_input_ids == IMAGE_TOKEN_INDEX).sum() == 0:
                ...
                # print(cur_input_embeds_1.device, cur_image_features.device, cur_input_embeds_2.device)
